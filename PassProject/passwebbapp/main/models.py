...
class Settings(models.Model):
    ...
    def __str__(self):
        return (f"length: {self.length}, numbers: {self.isNumbers}"
                f", letters: {self.isLetters}, special symbols: {self.isSpecial}")
...
class GeneratedPasswords(models.Model):
    password = models.CharField(max_length=255)
    association = models.CharField(max_length=255, default="", blank=True)
